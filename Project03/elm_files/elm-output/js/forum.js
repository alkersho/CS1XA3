...
var author$project$Forum$init = function (flag) {
	return _Utils_Tuple2(
		{error: '', postList: flag.posts, search: ''},
		elm$core$Platform$Cmd$none);
};
var author$project$Forum$SearchResponce = function (a) {
	return {$: 'SearchResponce', a: a};
};
var author$project$Forum$Post = F2(
	function (title, id) {
...
var author$project$Forum$decodePostList = elm$json$Json$Decode$list(
	A3(
		elm$json$Json$Decode$map2,
		author$project$Forum$Post,
		A2(elm$json$Json$Decode$field, 'title', elm$json$Json$Decode$string),
		A2(elm$json$Json$Decode$field, 'id', elm$json$Json$Decode$int)));
var author$project$Forum$errorHandler = F2(
...
var author$project$Forum$searchEncode = function (v) {
...
var author$project$Forum$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Search':
				var string = msg.a;
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$none);
			case 'SearchButton':
				return (model.search === '') ? _Utils_Tuple2(model, elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					model,
					elm$http$Http$post(
						{
							body: elm$http$Http$jsonBody(
								author$project$Forum$searchEncode(model.search)),
							expect: A2(elm$http$Http$expectJson, author$project$Forum$SearchResponce, author$project$Forum$decodePostList),
...
var author$project$Forum$SearchButton = {$: 'SearchButton'};
var author$project$Forum$GotoPost = function (a) {
	return {$: 'GotoPost', a: a};
};
...
var author$project$Forum$postCards = function (postList) {
	if (!postList.b) {
		return _List_Nil;
	} else {
		var x = postList.a;
		...
		return A2(
			...
			author$project$Forum$postCards(xs));
	}
};
...
var author$project$Forum$view = function (model) {
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								rundis$elm_bootstrap$Bootstrap$Form$Input$onInput(author$project$Forum$Search),
								rundis$elm_bootstrap$Bootstrap$Form$Input$value(model.search),
						...
						_List_fromArray(
							[
								...
								rundis$elm_bootstrap$Bootstrap$Button$onClick(author$project$Forum$SearchButton)
							]),
						_List_fromArray(
							[
				...
				author$project$Forum$postCards(model.postList))
			]));
};
...
var author$project$Forum$main = elm$browser$Browser$element(
	{
		init: author$project$Forum$init,
		subscriptions: function (_n0) {
			return elm$core$Platform$Sub$none;
		},
		update: author$project$Forum$update,
		view: author$project$Forum$view
	});
_Platform_export({'Forum':{'init':author$project$Forum$main(
	A2(
