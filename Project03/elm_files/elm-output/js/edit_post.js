...
var author$project$EditPost$init = function (flag) {
	return _Utils_Tuple2(
		{body: flag.body, error: '', postId: flag.postId, title: flag.title},
		elm$core$Platform$Cmd$none);
};
var author$project$EditPost$PostResponce = function (a) {
...
var author$project$EditPost$encodeRequest = function (v) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'postId',
				elm$json$Json$Encode$int(v.postId)),
				_Utils_Tuple2(
				'body',
				elm$json$Json$Encode$string(v.body))
			]));
};
var author$project$EditPost$errorHandler = F2(
...
var author$project$EditPost$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Body':
				var string = msg.a;
					...
					elm$http$Http$post(
						{
							body: elm$http$Http$jsonBody(
								author$project$EditPost$encodeRequest(model)),
							expect: elm$http$Http$expectString(author$project$EditPost$PostResponce),
							url: '/e/alkersho/forum/edit/' + (elm$core$String$fromInt(model.postId) + '/')
						}));
			default:
				var result = msg.a;
				if (result.$ === 'Ok') {
					...
					if (val === '') {
						return _Utils_Tuple2(
							...
							elm$browser$Browser$Navigation$load(
								'/e/alkersho/forum/' + (elm$core$String$fromInt(model.postId) + '/')));
					} else {
						return _Utils_Tuple2(
							_Utils_update(
								model,
					...
					var val = result.a;
					return _Utils_Tuple2(
						A2(author$project$EditPost$errorHandler, model, val),
						elm$core$Platform$Cmd$none);
				}
		}
	});
var author$project$EditPost$Body = function (a) {
	return {$: 'Body', a: a};
};
var author$project$EditPost$Submit = {$: 'Submit'};
...
var author$project$EditPost$errorMsg = function (model) {
	return (model.error === '') ? A2(elm$html$Html$div, _List_Nil, _List_Nil) : A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
...
var author$project$EditPost$view = function (model) {
	return A2(
		rundis$elm_bootstrap$Bootstrap$Grid$container,
		_List_Nil,
		_List_fromArray(
			[
				author$project$EditPost$errorMsg(model),
				elm$html$Html$text(model.title),
				rundis$elm_bootstrap$Bootstrap$Form$Textarea$textarea(
				_List_fromArray(
					[
						rundis$elm_bootstrap$Bootstrap$Form$Textarea$value(model.body),
						rundis$elm_bootstrap$Bootstrap$Form$Textarea$onInput(author$project$EditPost$Body),
				...
				_List_fromArray(
					[
						...
						rundis$elm_bootstrap$Bootstrap$Button$onClick(author$project$EditPost$Submit)
					]),
				_List_fromArray(
					[
...
var author$project$EditPost$main = elm$browser$Browser$element(
	{
		init: author$project$EditPost$init,
		subscriptions: function (_n0) {
			return elm$core$Platform$Sub$none;
		},
		update: author$project$EditPost$update,
		view: author$project$EditPost$view
	});
_Platform_export({'EditPost':{'init':author$project$EditPost$main(
	A2(
					...
					return A2(
						...
						function (body) {
							return elm$json$Json$Decode$succeed(
								{body: body, postId: postId, title: title});
						},
