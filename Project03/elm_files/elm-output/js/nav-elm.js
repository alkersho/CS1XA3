...
var author$project$NavBar$Model = F3(
	function (userName, navBarState, error) {
		return {error: error, navBarState: navBarState, userName: userName};
	});
...
var author$project$NavBar$init = function (flag) {
	...
	return flag.authorized ? _Utils_Tuple2(
		A3(author$project$NavBar$Model, flag.userName, navState, ''),
		navCmd) : _Utils_Tuple2(
		A3(author$project$NavBar$Model, '', navState, ''),
		navCmd);
};
