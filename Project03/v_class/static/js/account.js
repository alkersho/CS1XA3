...
var author$project$Account$Model = function (fName) {
	return function (lName) {
		return function (userType) {
			return function (userName) {
				return function (email) {
					return function (editingEmail) {
						return function (emailEdit) {
							return function (currentPass) {
...
var author$project$Account$EmailResponce = function (a) {
	return {$: 'EmailResponce', a: a};
};
var author$project$Account$PassResponce = function (a) {
	return {$: 'PassResponce', a: a};
};
...
var author$project$Account$encodeEmail = function (v) {
...
var author$project$Account$encodePass = F2(
		...
		return elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'newPass',
					elm$json$Json$Encode$string(string2))
				]));
	});
var author$project$Account$errorHandler = F2(
...
var author$project$Account$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Email':
				var string = msg.a;
						...
						elm$http$Http$post(
							{
								body: elm$http$Http$jsonBody(
									author$project$Account$encodeEmail(model.emailEdit)),
								expect: elm$http$Http$expectString(author$project$Account$EmailResponce),
				...
				if (bool) {
					...
					return _Utils_Tuple2(
						...
						elm$http$Http$post(
							{
								body: elm$http$Http$jsonBody(
									A2(author$project$Account$encodePass, model.currentPass, model.passwordEdit)),
								expect: elm$http$Http$expectString(author$project$Account$PassResponce),
								url: '/e/alkersho/account/'
							}));
				}
			case 'EmailResponce':
				...
				if (result.$ === 'Ok') {
					...
					var val = result.a;
					return _Utils_Tuple2(
						A2(author$project$Account$errorHandler, model, val),
						elm$core$Platform$Cmd$none);
				}
			default:
				var result = msg.a;
...
var author$project$Account$CPass = function (a) {
	return {$: 'CPass', a: a};
};
var author$project$Account$EditPass = function (a) {
	return {$: 'EditPass', a: a};
};
var author$project$Account$Password = function (a) {
	return {$: 'Password', a: a};
};
...
var author$project$Account$changePass = function (model) {
	return model.editingPass ? _List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$text('Current Passowrd:')
						])),
					A2(
					rundis$elm_bootstrap$Bootstrap$Table$td,
					_List_Nil,
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									rundis$elm_bootstrap$Bootstrap$Form$Input$onInput(author$project$Account$CPass)
								]))
						]))
				])),
			A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									rundis$elm_bootstrap$Bootstrap$Form$Input$onInput(author$project$Account$Password)
								]))
						]))
				])),
			A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							A2(elm$html$Html$Attributes$style, 'colspan', '2'))
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									author$project$Account$EditPass(false))
								]),
							_List_fromArray(
								[
									elm$html$Html$text('Change Passowrd')
								]))
						]))
				]))
		]) : _List_fromArray(
						...
						[
							...
							_List_fromArray(
								[
									...
									rundis$elm_bootstrap$Bootstrap$Button$onClick(
									author$project$Account$EditPass(true))
								]),
							_List_fromArray(
								[
									elm$html$Html$text('Edit Password')
								]))
						]))
				]))
		]);
...
var author$project$Account$Email = function (a) {
	return {$: 'Email', a: a};
};
...
var frandibar$elm_font_awesome_5$FontAwesome$HtmlTag = function (a) {
	return {$: 'HtmlTag', a: a};
};
var frandibar$elm_font_awesome_5$FontAwesome$Solid = {$: 'Solid'};
var frandibar$elm_font_awesome_5$FontAwesome$Span = {$: 'Span'};
...
var frandibar$elm_font_awesome_5$FontAwesome$edit = frandibar$elm_font_awesome_5$FontAwesome$Icon$Icon('edit');
...
var rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$myAuto = elm$html$Html$Attributes$class('my-auto');
var author$project$Account$editingEmail = function (model) {
	var _n0 = model.editingEmail;
	if (_n0) {
		return _List_fromArray(
			[
				...
				_List_fromArray(
					[
						rundis$elm_bootstrap$Bootstrap$Form$Input$onInput(author$project$Account$Email),
						rundis$elm_bootstrap$Bootstrap$Form$Input$value(model.emailEdit)
					])),
				A4(
				frandibar$elm_font_awesome_5$FontAwesome$iconWithOptions,
				frandibar$elm_font_awesome_5$FontAwesome$check,
				frandibar$elm_font_awesome_5$FontAwesome$Solid,
				_List_Nil,
				_List_fromArray(
					[
						A2(elm$html$Html$Attributes$style, 'cursor', 'pointer'),
						elm$html$Html$Events$onClick(
						author$project$Account$EditEmail(false)),
						rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$myAuto
					]))
			]);
	} else {
		return _List_fromArray(
			[
				...
				A4(
				frandibar$elm_font_awesome_5$FontAwesome$iconWithOptions,
				frandibar$elm_font_awesome_5$FontAwesome$edit,
				frandibar$elm_font_awesome_5$FontAwesome$Solid,
				_List_fromArray(
					[
						frandibar$elm_font_awesome_5$FontAwesome$HtmlTag(frandibar$elm_font_awesome_5$FontAwesome$Span)
					]),
				_List_fromArray(
					[
						A2(elm$html$Html$Attributes$style, 'cursor', 'pointer'),
						elm$html$Html$Events$onClick(
						author$project$Account$EditEmail(true)),
...
var rundis$elm_bootstrap$Bootstrap$Table$rowDanger = rundis$elm_bootstrap$Bootstrap$Table$RoledRow(
	rundis$elm_bootstrap$Bootstrap$Table$Roled(rundis$elm_bootstrap$Bootstrap$Internal$Role$Danger));
var author$project$Account$errorMsg = function (model) {
	return (model.error === '') ? A2(rundis$elm_bootstrap$Bootstrap$Table$tr, _List_Nil, _List_Nil) : A2(
		rundis$elm_bootstrap$Bootstrap$Table$tr,
		_List_fromArray(
			[rundis$elm_bootstrap$Bootstrap$Table$rowDanger]),
		_List_fromArray(
			[
				A2(
				rundis$elm_bootstrap$Bootstrap$Table$td,
...
var rundis$elm_bootstrap$Bootstrap$Table$responsiveMd = rundis$elm_bootstrap$Bootstrap$Table$Responsive(
	elm$core$Maybe$Just(rundis$elm_bootstrap$Bootstrap$General$Internal$MD));
...
var author$project$Account$view = function (model) {
	return A2(
			...
			[
				rundis$elm_bootstrap$Bootstrap$Table$table(
				{
					options: _List_fromArray(
						[rundis$elm_bootstrap$Bootstrap$Table$striped, rundis$elm_bootstrap$Bootstrap$Table$responsiveMd]),
					tbody: A2(
						...
						_Utils_ap(
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													elm$html$Html$text(model.fName)
												]))
										])),
									A2(
									rundis$elm_bootstrap$Bootstrap$Table$tr,
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													elm$html$Html$text(model.lName)
												]))
										])),
									A2(
									rundis$elm_bootstrap$Bootstrap$Table$tr,
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													elm$html$Html$text(model.userType)
												]))
										])),
									A2(
									rundis$elm_bootstrap$Bootstrap$Table$tr,
									...
									_List_fromArray(
										[
											...
											author$project$Account$editingEmail(model))
										])),
									A2(
									rundis$elm_bootstrap$Bootstrap$Table$tr,
									_List_Nil,
							...
							_Utils_ap(
								author$project$Account$changePass(model),
								_List_fromArray(
									[
										author$project$Account$errorMsg(model)
									])))),
					thead: rundis$elm_bootstrap$Bootstrap$Table$simpleThead(_List_Nil)
				})
			]));
};
...
var author$project$Account$main = elm$browser$Browser$element(
	{
		...
		update: author$project$Account$update,
		view: author$project$Account$view
	});
_Platform_export({'Account':{'init':author$project$Account$main(
	A2(
							...
							return A2(
								...
								function (gender) {
									return A2(
										...
										A2(elm$json$Json$Decode$field, 'fName', elm$json$Json$Decode$string));
								},
								A2(elm$json$Json$Decode$field, 'gender', elm$json$Json$Decode$string));
						},
						A2(elm$json$Json$Decode$field, 'lName', elm$json$Json$Decode$string));
				},
				A2(elm$json$Json$Decode$field, 'userName', elm$json$Json$Decode$string));
		},
		A2(elm$json$Json$Decode$field, 'userType', elm$json$Json$Decode$string)))(0)}});}(this));