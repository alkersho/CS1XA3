...
var author$project$Post$init = function (flag) {
	...
	function (msg, model) {
		if (msg.$ === 'NoOp') {
			...
			return _Utils_Tuple2(
				model,
				elm$browser$Browser$Navigation$load('/e/alkersho/forum/edit/' + (model.id + '/')));
		}
	});
var author$project$Post$Edit = {$: 'Edit'};
									...
									[
										...
										_List_fromArray(
											[
												...
												elm$html$Html$Events$onClick(author$project$Post$Edit)
				...
				A3(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2(elm_explorations$markdown$Markdown$toHtml, _List_Nil, model.body)
								]))
						]),
...
var author$project$Post$main = elm$browser$Browser$element(
	{
		init: author$project$Post$init,
		subscriptions: function (_n0) {
			return elm$core$Platform$Sub$none;
		},
		update: author$project$Post$update,
		view: author$project$Post$view
	});
_Platform_export({'Post':{'init':author$project$Post$main(
	A2(
							...
							return A2(
								...
								function (body) {
									return elm$json$Json$Decode$succeed(
										{body: body, canEdit: canEdit, id: id, title: title});
								},
								A2(elm$json$Json$Decode$field, 'body', elm$json$Json$Decode$string));
						},
						A2(elm$json$Json$Decode$field, 'canEdit', elm$json$Json$Decode$bool));
				},
